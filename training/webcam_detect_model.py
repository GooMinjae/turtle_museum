...
class DualCamYoloNode(Node):
    def __init__(self):
        ...
        self.model_path = "/home/rokey/train_ws/src/runs/detect/yolov8-custom-org_dataset4/weights/best.pt"  # 현재 최종
        self.conf_thres = 0.10  # YOLO confidence

        # [CAMERA]
        # ▶ 사용 장치 번호 (예: 노트북 내장=0, 외장=2)
        self.CAMERA_INDEXES = [0, 2]  # 필요 시 [1, 2] 등으로 변경
