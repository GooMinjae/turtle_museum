...
class Guiding_work(Node):
    def __init__(self):
        super().__init__('Guiding_work_node')
        ...
        self.count_people_match = Subscriber(self, bool, '/robot8/count_people_match', 10) # 사람 수 맞추기
        
        # tracking 필요 Subscriptions
